...
if (!empty($startDate) && !empty($endDate)) {
    $sql .= " WHERE tgl_kirim BETWEEN ? AND ?";
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="text-center mb-4">Rekap Surat Keluar</h2>
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>" . htmlspecialchars(date('d-m-Y', strtotime($row["tgl_kirim"]))) . "</td>
                              </tr>";
                    }
                } else {
    ...
    <script>
        ...
        window.onafterprint = function () {
            window.location.href = "rekap_sk.php"; // Redirect back to the main page
        };
    </script>
