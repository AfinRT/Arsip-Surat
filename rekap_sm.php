...
if (!empty($startDate) && !empty($endDate)) {
    $sql .= " WHERE tanggal_surat BETWEEN ? AND ?";
...
<<div class="container">
    ...
    <form method="GET" action="">
        ...
        <a href="rekap_sm.php" class="btn btn-light"><i class="fas fa-sync-alt"></i></a>
    </form>
    <button onclick="window.location.href='cetak_sm.php?start_date=<?= $startDate ?>&end_date=<?= $endDate ?>'" class="btn btn-secondary"><i class="fas fa-print"></i> Print</button>
</div>
